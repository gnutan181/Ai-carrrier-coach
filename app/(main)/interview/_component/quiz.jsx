...
const startNewQuiz = ()=>{
  ...
  if(resultData){
    return (
        <div>
            <QuizResult result={resultData} orStartNew={startNewQuiz} />
        </div>
    )
  }
  if (!quizData) {
...
const question =quizData&& quizData[currentQuestion];
...
const finishQuiz = async()=>{
    ...
    try {
       ...
       toast.error(error.message || "faild to save quiz results") 
    }
}
