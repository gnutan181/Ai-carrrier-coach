...
const DashboardView = ({insights}) => {
    ...
    {addSuffix:true})
    // console.log(nextUpdateDistance,lastUpdatedDate)
  return (
...
{/* 5 card-chart */}
<Card className="sm:col-span-2 md:col-span-2 lg:col-span-4">
        <CardHeader>
          ...
          <div className="h-[400px]">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={salaryData}>
                ...
                <XAxis dataKey="name" className="xs:text-xs" />
                <YAxis />
                <Tooltip
